...
@implementation DLLaunchAdModel
...
@property (nonatomic, strong) DLLaunchAdModel *adModel;
...
-(void)setAdModel:(DLLaunchAdModel *)adModel{
    _adModel = adModel;
    [DLImageCache loadImage:self.adImageView imageUrl:adModel.adUrl];
    __block NSInteger second = adModel.adCount;
    if (adModel.countdownShow) {
        [self.skipButton setTitle:[NSString stringWithFormat:@"%ldS 跳过", second] forState:UIControlStateNormal];
    }
